package club.emperorws.orm.plus.entity;

import club.emperorws.orm.annotations.AnnModel;
import club.emperorws.orm.plus.config.SnowFlakeIdGen;
...
public class Student {
    ...
    @AnnModel.AnnField(column = "id", property = "id", jdbcType = "BIGINT", isPkGen = true, genId = SnowFlakeIdGen.class)
    private Long id;
