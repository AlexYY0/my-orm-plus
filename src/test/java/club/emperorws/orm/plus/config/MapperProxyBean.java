...
public class MapperProxyBean implements IMapperProxyBean {
    ...
    public void init() {
        ...
        //4. 添加Mapper扫描
        configuration.addMapperPackages("club.emperorws.orm.plus.mapper", "club.emperorws.orm.plus.mapper2");
        SqlSessionFactoryProxyBean.me().init(configuration);
        //5. 添加扫描实体信息
        TableModelInfoHelper.scanPackageAddTableModelInfo(configuration, "club.emperorws.orm.plus.entity", "club.emperorws.orm.plus.entity2");
